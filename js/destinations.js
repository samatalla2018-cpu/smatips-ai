...
const DESTINATION_THEMES = {
  ...
  sharm: { label: 'شرم الشيخ', mood: 'شعاب مرجانية ومياه البحر الأحمر', heroImage: 'https://images.unsplash.com/photo-1544551763-46a013bb70d5?q=80&w=1200&auto=format&fit=crop', cardImage: 'https://images.unsplash.com/photo-1544551763-46a013bb70d5?q=80&w=480&auto=format&fit=crop', tint: '#2FA79A' },
  ...
  bali: { label: 'بالي', mood: 'معابد هادئة وطبيعة استوائية خلابة', heroImage: 'https://images.unsplash.com/photo-1537996194471-e657df975ab4?q=80&w=1200&auto=format&fit=crop', cardImage: 'https://images.unsplash.com/photo-1537996194471-e657df975ab4?q=80&w=480&auto=format&fit=crop', tint: '#2FA79A' },
